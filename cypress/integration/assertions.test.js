describe('tests for the building-block assertion commands', () => {
    ...
    describe('test_text', () => {
        ...
        it('tests the text content and styling of the nth element with that data-testid', () => {
            cy.test_text('test-paragraph', 'Second paragraph with duplicate data-testid', { 'color': 'rgb(128, 0, 128)' }, 2)
        })
    })
    ...
    describe('test_visibility', () => {
        ...
        it('tests the visibility of the nth element with that data-testid', () => {
            cy.test_visibility('test-paragraph', { instance: 1 }).should('contain', 'Blah blah blah')
            cy.test_visibility('test-paragraph', { instance: 2 }).should('contain', 'Second paragraph with duplicate data-testid')
        })
